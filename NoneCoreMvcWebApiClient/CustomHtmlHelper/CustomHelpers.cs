...
namespace MvcApp.CustomHtmlHelper
{
    ...
    public static class CustomDropList
    {
    ...
    /// <summary>
    /// Render partial class its method return a html string perfect to send to a Jquery post to 
    /// render a part of a page on a JQuery Post.
    /// </summary>
